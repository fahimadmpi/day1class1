...
<body>
    ...
    <header class="cont">
        <div class="row topbar">
            ...
            <div class="col-lg-6 top-right text-end">
                <p>১৯ কার্তিক, ১৪২৯</p>
                <a href="#">English</a>
            </div>
        </div>
    ...
    <section class="cont">
        <div class="row logo">
            <div class="col-lg-5 logo_left">
                <a href="#"><img src="./image/header/logo_bn.png" alt="logo"></a>
            </div>
            ...
            <div class="col-lg-2 logo_right d-flex justify-content-end">
                <div class="logo1">
                    <a href="#"><img src="./image/header/a2i-logo-footer.png" alt=""></a>
                </div>
                <div class="logo2">
                    <p>সাথে থাকুন</p>
                    <a href="#"><img src="./image/header/facebook-icon.png" alt=""></a>
                    <a href="#"><img src="./image/header/twitter-blue-icon.png" alt=""></a>
                    <a href="#"><img src="./image/header/youtube-icon.png" alt=""></a>
                    <a href="#"><img src="./image/header/gplus-icon.png" alt=""></a>
                </div>
            </div>
    ...
    <section class="cont">
        <div class="row hero">
            ...
            <div class="col-lg-4 hero_side">
              <div class="side_img">
                <a href="#"><img src="./image/sidebar/Bangladesh-Directory.jpg" class="d-block w-100 pb-2" alt=""></a>
                <a href="#"><img src="./image/sidebar/Bangladesh-Directory.jpg" class="d-block w-100 pb-2" alt=""></a>
                <a href="#"><img src="./image/sidebar/Bangladesh-Directory.jpg" class="d-block w-100 pb-2" alt=""></a>
                <a href="#"><img src="./image/sidebar/Bangladesh-Directory.jpg" class="d-block w-100 pb-2" alt=""></a>
                <a href="#"><img src="./image/sidebar/Bangladesh-Directory.jpg" class="d-block w-100 pb-2" alt=""></a>
